...
void cgraphics_menubar_add_key_binding(widget_t * widget, list_item_t *item,
  const char * utf8_key,int modifier);
...
void cgraphics_image_load_inline_png( image_t *img, const unsigned char * data,
  int len );
