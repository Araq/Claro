...
def cmd_examples(ccflags):
  ccflags += ccflags + " -I. -I./include -I/usr/include/cairo"
  ldflags = buildCcFlags(CC) + " -L./build -lclaro"
  Compile("build/hello", ["examples/helloworld/hello.c"], ccflags, ldflags)
  Compile("build/radio", ["examples/radio/radio.c"], ccflags, ldflags)
  Compile("build/combo", ["examples/combo/combo.c"], ccflags, ldflags)
  Compile("build/layout_test", ["examples/layout/layout_test.c"], ccflags, ldflags)
  Compile("build/layout_any", ["examples/layout/layout_any.c"], ccflags, ldflags)
  Compile("build/splitter", ["examples/splitter/splitter-test.c"], ccflags, ldflags)
  Compile("build/cldlg", ["examples/cldlg/cldlg.c"], ccflags, ldflags)
  Compile("build/designer", ["examples/designer/designer.c"], ccflags, ldflags)
  Compile("build/progress", ["examples/progress/progress-test.c"], ccflags, ldflags)
  Compile("build/image", ["examples/image/image.c"], ccflags, ldflags)
  Compile("build/list", ["examples/list/list.c"], ccflags, ldflags)
  Compile("build/listview", ["examples/list/listview.c"], ccflags, ldflags)
  Compile("build/workspace", ["examples/workspace/workspace.c"], ccflags, ldflags)
